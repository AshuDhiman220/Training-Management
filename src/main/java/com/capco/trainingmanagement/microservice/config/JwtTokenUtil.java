...
public class JwtTokenUtil implements Serializable {
    ...
    private Claims getAllClaimsFromToken(String token) {
        return Jwts.parser()
                .setSigningKey(LoginAndRegistrationConstants.SIGNING_KEY)
    ...
    private String doGenerateToken(String subject) {
        ...
        return Jwts.builder()
                .setClaims(claims)
                .setIssuer("http://capco.com")
                .setIssuedAt(new Date(System.currentTimeMillis()))
                .setExpiration(new Date(System.currentTimeMillis() + LoginAndRegistrationConstants.ACCESS_TOKEN_VALIDITY_SECONDS*1000))
                .signWith(SignatureAlgorithm.HS256, LoginAndRegistrationConstants.SIGNING_KEY)
                .compact();
    }
